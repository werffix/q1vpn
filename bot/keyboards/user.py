...
def connect_android_kb(subscription_url: str = None) -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    if subscription_url:
        builder.row(
            InlineKeyboardButton(text="🔗 Активировать VPN-профиль", url=subscription_url)
        )
    builder.row(
...
def connect_ios_kb(subscription_url: str = None) -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    if subscription_url:
        builder.row(
            InlineKeyboardButton(text="🔗 Активировать VPN-профиль", url=subscription_url)
...
def connect_windows_kb(subscription_url: str = None) -> InlineKeyboardMarkup:
    builder = InlineKeyboardBuilder()
    if subscription_url:
        builder.row(
            InlineKeyboardButton(text="🔗 Активировать VPN-профиль", url=subscription_url)
