...
# Базовая публичная SUB-ссылка, которую получает пользователь.
# Формат итоговой ссылки: {SUBSCRIPTION_BASE_URL}/{subId}
SUBSCRIPTION_BASE_URL = os.getenv("SUBSCRIPTION_BASE_URL", "https://vpn.cdcult.ru:2096/sub").rstrip("/")
