...
# Aggregator subscription URL (например: https://my-bot-domain)
# Если пусто, используется fallback на ссылку панели.
SUBSCRIPTION_AGGREGATOR_URL = os.getenv("SUBSCRIPTION_AGGREGATOR_URL", "").rstrip("/")
